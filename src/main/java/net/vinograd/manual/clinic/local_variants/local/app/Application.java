package net.vinograd.manual.clinic.local_variants.local.app;

import net.vinograd.manual.clinic.local_variants.local.repositories.LocalAppointmentRepository;
import net.vinograd.manual.clinic.local_variants.local.repositories.LocalDoctorRepository;
import net.vinograd.manual.clinic.local_variants.local.repositories.LocalPatientRepository;
import net.vinograd.manual.clinic.local_variants.local.service.LocalDoctorService;
import net.vinograd.manual.clinic.local_variants.local.service.LocalReceptionService;
